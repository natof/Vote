...
use natof\vote\librairie\gui\tasks\DelayTasks;
use natof\vote\Vote;
...
class DoubleChestInventory extends SimpleChestInventory
{
    ...
    public function send(Player $player)
    {
        if (!isset($this->hasSend[$player->getXuid()])) {
            ...
            Vote::getInstance()->getScheduler()->scheduleDelayedTask(new DelayTasks($player, $this), 2); // Delay for PS4 /!\ and switch GUI use bug.
