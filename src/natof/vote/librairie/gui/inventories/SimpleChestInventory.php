...
class SimpleChestInventory extends BaseInventoryCustom
{
    ...
    public function send(Player $player)
    {
        if (!isset($this->hasSend[$player->getXuid()])) {
            ...
            $player->getNetworkSession()->sendDataPacket(UpdateBlockPacket::create(BlockPosition::fromVector3($this->holder), RuntimeBlockMapping::getInstance()->toRuntimeId(VanillaBlocks::CHEST()->getTypeId()), UpdateBlockPacket::FLAG_NETWORK, UpdateBlockPacket::DATA_LAYER_NORMAL));
